...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-8 mt-lg-5 text-center">
                        ...
                        <div data-aos="fade-up" data-aos-delay="100">
                            ...
                            <a href="<?php echo base_url(); ?>members/register.php" class="btn smoothscroll btn-success mr-2 mb-2">Members Sign In</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="site-section" id="members-section">
            <div class="container">
                <div class="row mb-5 justify-content-center">
                    <div class="col-md-7 text-center">
                        <h2 class="section-title mb-3" data-aos="fade-up" data-aos-delay="">Our Members</h2>
                        <p class="lead" data-aos="fade-up" data-aos-delay="100">This are the active members using the system.</p>
                    </div>
                </div>
                <div class="row">
                    <?php $active_members = $members->find_all_by_status($status); ?>

                    <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
                        <div class="owl-carousel slide-one-item-alt">
                            <?php foreach ($active_members as $member) { ?>
                                <img src="<?php echo public_url(); ?>storage/users/<?php echo htmlentities($member['image']) ?>" alt="Image" class="img-fluid">
                            <?php } ?>
                        </div>
                ...
                <div id="posts" class="row no-gutter">
                    ...
                    <?php foreach ($active_vehicles as $car) { ?>
                        <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                            <a href="<?php echo public_url(); ?>storage/vehicles/<?php echo htmlentities($car['profile']) ?>" class="item-wrap fancybox" data-fancybox="gallery2">
