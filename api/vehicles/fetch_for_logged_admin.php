...
$admin_vehicles = $vehicles->find_all_by_admin_id_and_status($current_admin["id"], $status);

$num_vehicles = count($admin_vehicles);
...
$query .= "WHERE admin_id = '{$current_admin['id']}' AND status = '{$status}' ";
