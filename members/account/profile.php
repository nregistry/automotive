                ...
                <form id="changePhotoForm">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="hidden" id="changePhotoMmberId" name="member_id" class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputFile">Change Photo</label>
                            <input type="file" name="photo" id="memberProfilePic">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="settingsForm" autocomplete="off">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="hidden" id="settingsAdminId" class="form-control" name="member_id" />
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="accountSettingsForm" autocomplete="off">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="hidden" id="settingsAccountMemberId" class="form-control" name="member_id" />
                        </div>
                        <div class="form-group">
                            <label for="settingsAccountEmail">Email Address</label>
                            <input type="email" id="settingsAccountEmail" class="form-control" name="email" placeholder="Enter Member Email Address" />
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="changePasswordForm" autocomplete="off">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="hidden" id="changePasswordMemberId" class="form-control" name="member_id" />
                        </div>
                        <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $('#changePhotoBtn').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#changePhotoMmberId').val(data.id);
        ...
        $('#changePhotoForm').submit(function(event) {
            ...
            var photo = $('#memberProfilePic').val();
            if (photo == '') {
                ...
                if (jQuery.inArray(extension, ['gif', 'png', 'jpg', 'jpeg']) == -1) {
                    ...
                    $('#memberProfilePic').val('');
                    return false;
                } else {
                    $.ajax({
                        url: "<?php echo base_url(); ?>api/members/change_photo.php",
                        type: "POST",
        ...
        $('#settingsBtn').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#settingsFullNames').val(data.fullnames);
                    $('#settingsPhone').val(data.phone);
                    $('#settingsDOB').val(data.dob);
                    $('#settingsAddress').val(data.address);
                    $('#settingsLocation').val(data.location);
        ...
        $('#settingsForm').submit(function(event) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>api/members/update_member.php",
                type: "POST",
                data: form_data,
                dataType: "json",
                beforeSend: function() {
        ...
        $('#accountSettingsBtn').click(function() {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function(data) {
                    $('#settingsAccountMemberId').val(data.id);
                    $('#settingsAccountEmail').val(data.email);
                    $('#settingsPhone').val(data.phone);
                    $('#settingsAccountUsername').val(data.username);
        ...
        $('#accountSettingsForm').submit(function(event) {
            ...
            var form_data = $(this).serialize();
            $.ajax({
                url: "<?php echo base_url(); ?>api/members/update_account.php",
                type: "POST",
                data: form_data,
                dataType: "json",
                beforeSend: function() {
        ...
        $('#changePasswordBtn').click(function() {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function(data) {
                    $('#changePasswordMemberId').val(data.id);
        ...
        $('#changePasswordForm').submit(function(event) {
            ...
            var form_data = $(this).serialize();
            $.ajax({
                url: "<?php echo base_url(); ?>api/members/update_password.php",
                type: "POST",
                data: form_data,
                dataType: "json",
                beforeSend: function() {
