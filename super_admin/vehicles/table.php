        ...
        <div class="card card-default card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="#" class="btn btn-primary btn-sm" id="newVehicleTableBtn">
                        <i class="fa fa-plus"></i> Create Table
                    </a>

                    <a href="#" class="btn btn-danger btn-sm" id="deleteVehicleTableBtn">
...
<script>
    $(document).ready(function() {
        $('#newVehicleTableBtn').click(function(e) {
            e.preventDefault();
            var action = "CREATE_TABLE";
            $.ajax({
                url: "<?php echo base_url(); ?>api/vehicles/vehicles_table.php",
                type: "POST",
                data: {
                    action: action
                },
        ...
        $('#deleteVehicleTableBtn').click(function(e) {
            e.preventDefault();
