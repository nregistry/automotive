        ...
        <div class="card card-default card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="#" class="btn btn-primary btn-sm" id="newRolesTableBtn">
                        <i class="fa fa-plus"></i> Create Table
                    </a>

                    <a href="#" class="btn btn-danger btn-sm" id="deleteRolesTableBtn">
            ...
            <!-- /.card-body -->
            <div class="card-body">
                <p>This are the fields for Roles table.</p>
...
<script>
    $(document).ready(function() {
        $('#newRolesTableBtn').click(function(e) {
            e.preventDefault();
            var action = "CREATE_TABLE";
            $.ajax({
                url: "<?php echo base_url(); ?>api/roles/roles_table.php",
                type: "POST",
                data: {
                    action: action
                },
        ...
        $('#deleteRolesTableBtn').click(function(e) {
            e.preventDefault();
