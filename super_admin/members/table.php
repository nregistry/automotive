        ...
        <div class="card card-default card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="#" class="btn btn-primary btn-sm" id="newMemberTableBtn">
                        <i class="fa fa-plus"></i> Create Table
                    </a>

                    <a href="#" class="btn btn-danger btn-sm" id="deleteMemberTableBtn">
            ...
            <!-- /.card-body -->
            <div class="card-body">
                <p>This are the fields for Admins table.</p>
...
<script>
    $(document).ready(function() {
        $('#newMemberTableBtn').click(function(e) {
            e.preventDefault();
            var action = "CREATE_TABLE";
            $.ajax({
                url: "<?php echo base_url(); ?>api/members/members_table.php",
                type: "POST",
                data: {
                    action: action
                },
        ...
        $('#deleteMemberTableBtn').click(function(e) {
            e.preventDefault();
