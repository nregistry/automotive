        ...
        <div class="card card-default card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="#" class="btn btn-primary btn-sm" id="newAdminsTableBtn">
                        <i class="fa fa-plus"></i> Create Table
                    </a>

                    <a href="#" class="btn btn-danger btn-sm" id="deleteAdminsTableBtn">
...
<script>
    $(document).ready(function() {
        $('#newAdminsTableBtn').click(function(e) {
            e.preventDefault();
            var action = "CREATE_TABLE";
            $.ajax({
                url: "<?php echo base_url(); ?>api/admins/admin_table.php",
                type: "POST",
                data: {
                    action: action
                },
        ...
        $('#deleteAdminsTableBtn').click(function(e) {
            e.preventDefault();
