        ...
        <div class="card card-default card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="#" class="btn btn-primary btn-sm" id="newMailTableBtn">
                        <i class="fa fa-plus"></i> Create Table
                    </a>

                    <a href="#" class="btn btn-danger btn-sm" id="deleteMailTableBtn">
            ...
            <!-- /.card-body -->
            <div class="card-body">
                <p>This are the fields for Mail table.</p>
...
<script>
    $(document).ready(function() {
        $('#newMailTableBtn').click(function(e) {
            e.preventDefault();
            var action = "CREATE_TABLE";
            $.ajax({
                url: "<?php echo base_url(); ?>api/mail/mails_table.php",
                type: "POST",
                data: {
                    action: action
                },
        ...
        $('#deleteMailTableBtn').click(function(e) {
            e.preventDefault();
