        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">My Vehicles Table</h3>
                    <div class="card-tools">
                        <a href="#" id="newVehicleBtn" class="btn btn-tool btn-sm btn-success">
    ...
    <div class="modal fade" id="newVehicleModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="newVehicleForm" autocomplete="off">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="hidden" id="newVehicleRequestsAdminId" class="form-control" name="admin_id" />
                        </div>
    ...
    $(document).ready(function() {
        ...
        function find_vehicles() {
            ...
            var dataTable = $('#loadVehicles').DataTable({
                ...
                "order": [],
                "ajax": {
                    url: "<?php echo base_url(); ?>api/vehicles/fetch_for_logged_admin.php",
                    type: "POST",
                    data: {
                        status: status
                    }
        ...
        $('#newVehicleBtn').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#newVehicleRequestsAdminId').val(data.id);
        ...
        $('#newVehicleForm').submit(function(event){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>api/vehicles/new_for_admin.php",
                type: "POST",
                data: form_data,
                dataType: "json",
                beforeSend:function(){
        ...
        $(document).on('click', '.view', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    window.location.href = '<?php echo base_url(); ?>admin/vehicles/profile.php?vehicle=' + vehicle_id;
